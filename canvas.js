export class Canvas {
  ...
  drawText() {
    ...
    this.ctx.fillText(`Марта!`,    this.cx + 200, this.cy - textSize)
    this.ctx.fillText(`Любимая`,  this.cx + 200, this.cy)
    this.ctx.fillText(`Викуля 💘 `,     this.cx + 200, this.cy + textSize)
    this.ctx.textAlign = `right`
    this.ctx.fillText(`С`,    this.cx - 200, this.cy)
  }
